### Welcome to Chapter 3: Data Visualization

This folder contains the instructions for creating the visualizations with various Python libraries, and uses some of the libraries declared in the [project environment](../pyproject.toml). Follow the [root README setup](../README.md#lab-setup-uv) and run `uv sync` from the repository root before starting this chapter.
