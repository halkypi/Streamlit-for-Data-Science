...
This folder contains the files for the Goodreads demo application, which shows us how to make an end to end project in Streamlit. It uses some of the libraries declared in the [project environment](../pyproject.toml). Follow the [root README setup](../README.md#lab-setup-uv) and run `uv sync` from the repository root before starting this chapter.
